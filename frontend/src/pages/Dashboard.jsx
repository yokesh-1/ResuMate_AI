...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      bg-clip-text text-transparent sm:hidden '> Welcome, Deva</p>
        ...
        </div>
        {
          showCreateResume && (
            <form
              ...
              onSubmit={createResume} onClick={() => setShowCreateResume(false)}
        ...
        {
          showUploadResume && (
            // Full-screen overlay that appears when the upload resume modal is open
            <form
              ...
              {/*   Modal content container.
                          stopPropagation prevents the click from reaching the parent form,
              ...
              >
                ...
                {/*  Resume title input.
               The value is controlled by the `title` state.
               ...
               */}
                ...
                {/* 
          Submit button.
          Clicking this triggers the form's `onSubmit` handler,
          which calls the `uploadResume` function.
        */}
                <button className="w-full py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors" >Upload Resume</button>
                {/* 
          Close icon.
          Clicking it closes the modal and clears the resume title
        ...
        */}
          ...
          editResumeId && (
            <form
              ...
              onSubmit={editTitle} onClick={() => setEditResumeId('')}
              className="fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center" >
              <div
                onClick={e => e.stopPropagation()}
                className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6"
